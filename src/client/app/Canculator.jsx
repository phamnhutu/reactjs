...
class Canculator extends React.Component {
         ...
         <div>            
            <table>
                ...
                <tr key={'1'}>                    
                    ...
                    <td><button deleteLetter={this.deleteLetter} style={{width:'30px',height:'30px'}} onClick = {this.deleteLetter.bind(this)}>{'<-'}</button></td>
                </tr>
                <tr key={'2'}>
